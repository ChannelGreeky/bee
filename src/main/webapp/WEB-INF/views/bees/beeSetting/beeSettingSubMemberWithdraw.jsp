...
<div class="uTabNav">
    ...
    <button type="button" onclick="location.href='/beeSettingSubMemberWithdrawDo.do'" class="btn _moveToBlockMemberPage sf_color">차단 목록</button>
</div>
...
<span class="etc">
    <button type="button" class="_btnManageMemberWithdrawal uButton -sizeS -alert " style="display: inline-block;">탈퇴</button>
	<button type="button" class="_btnManageMemberWithdrawal uButton -sizeS -reverse" style="display: inline-block;margin-left: 5px;">차단</button>
