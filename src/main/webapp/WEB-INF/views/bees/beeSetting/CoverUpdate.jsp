    ...
    <fieldset>
        ...
        <div class="makeCover">
            ...
            <div class="uInput -simpleLine inputBand">
                ...
                <input value="" type="text" class="_inputBandName" id="ex_name" maxlength="50" placeholder="여행을 좋아하는 사람들">
            </div>
        ...
        <div class="btnFooter">
            <button type="button" onclick="location.href='/beeSettingMain.do'" class="_btnCancel uButton -sizeXL -cancel">취소</button>
